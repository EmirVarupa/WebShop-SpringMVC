...
//nije zavrseno
	...
	public String processAddNewProductForm(@ModelAttribute("newProduct") @Valid Product newProduct, BindingResult result,
		...
		return "redirect:/products/adminPage";
	}
	...
	public String processUpdateNewProductForm(@ModelAttribute("newProduct") Product newProduct, BindingResult result,
			HttpServletRequest request) {
	...
	public String getDeleteProductForm(@RequestParam("id") String productId) {
	...
	public void initialiseBinder(WebDataBinder binder) {
		...
		binder.setAllowedFields("productId", "name", "unitPrice", "description", "manufacturer", "category",
				"unitsInStock", "productImage", "language", "condition");
